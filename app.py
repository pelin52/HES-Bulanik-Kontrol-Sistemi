...
class HESProDashboard:
    def __init__(self, root):
        ...
        self.btn_analiz = tk.Button(self.control_frame, text="MANUEL ANALİZ ET", command=self.hesapla, bg="#4e4e4e", fg="white", activebackground="#3a3a3a", activeforeground="white", font=("Segoe UI", 10, "bold"), bd=0, cursor="hand2", pady=6, padx=10)
    ...
    def create_custom_scale(self, label, min_v, max_v):
        ...
        lbl.pack(anchor="w")
        scale = tk.Scale(frame, from_=min_v, to=max_v, orient='horizontal', bg="#2d2d2d", fg="#aaaaaa", troughcolor="#1e1e1e", highlightbackground="#2d2d2d", activebackground="#007acc", bd=0, font=("Segoe UI", 9), command=lambda val: self.hesapla())
